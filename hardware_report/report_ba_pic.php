...
<section class="content">
	<div class="nav-tabs-custom">
    	<ul class="nav nav-tabs">
    	    <li><a href="?page=report_ba">รายงานการยืม-คืน-ยืมต่อ หนังสือ </a></li>
    	    <li class="active"><a href="#">รายงานการยืม-คืน-ยืมต่อ หนังสือ (แสดงภาพ)</a></li>
    	</ul>
    	<div class="tab-content">
			<div class="row">
			    <div class="col-sm-12">
			    	<form class="form" id="ba_form" name="ba_form" method="post" target="report_generate" action="report_ba_pic_generate.php" >
						...
						<div class="form-group col-md-2">
						    ...
						    <select class="form-control" name="group" >
						    	...
						    	?>
						    	<option value="<?php echo $value_group['re_ba_station_id']; ?>"><?php echo $value_group['re_ba_station_id']; ?></option>
						    	<?php } ?>
						    </select>
						</div>
						<div class="form-group col-md-2">
