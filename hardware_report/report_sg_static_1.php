...
<section class="content">
	<div class="nav-tabs-custom">
    	<ul class="nav nav-tabs">
    	    ...
    	    <li class="active"><a href="#">รายงานสถิติหนังสือ</a></li>
    	</ul>
    	<div class="tab-content">
			<div class="row">
			    <div class="col-md-12">
			    	<form class="form" id="sg_form" name="sg_form" method="post" target="report_generate" action="report_sg_static_1_generate.php">
