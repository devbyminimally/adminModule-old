...
<section class="content">
	<div class="nav-tabs-custom">
    	<ul class="nav nav-tabs">
    	    <li class="active"><a href="#"><?=$lang_report_sc_1; ?></a></li>
    	...
    	<div class="tab-content">
			<div class="row">
			    <div class="col-sm-12">
			    	<form class="form" id="sc_form" name="sc_form" method="post" target="report_generate" action="report_sc_generate.php" >
						...
						<div class="form-group col-md-8">
			                ...
			                <select class="form-control select2" name="fieldName[]" multiple="multiple" data-placeholder="Select a State" style="width: 100%;">
				    			...
				    			<option value="3" selected="selected"><?=$lang_type; ?></option>
			                    <option value="4" selected="selected"><?=$lang_member_id; ?></option>
			                    <option value="5" selected="selected"><?=$lang_member_name; ?></option>
			                    <option value="6" selected="selected"><?=$lang_book_id; ?></option>
			                    <option value="7" selected="selected"><?=$lang_book_name; ?></option>
			                    <option value="8" selected="selected"><?=$lang_due_date; ?></option>
			                    <option value="9" selected="selected"><?=$lang_status; ?></option>
			                </select>
			            </div>
