...
<body class="hold-transition skin-blue-light sidebar-mini fixed">
  <div class="wrapper">
    ...
    <?php 
      $control_bd_video = 'class="imgmenu"';
      $control_bd_message = 'class="imgmenu"';
      $control_bd_recommended = 'class="imgmenu"';
      $control_bd_checkBin = 'class="imgmenu"';
      if($_GET['page'] == 'control_bd_video'){ $control_bd_video = ''; }
      else if($_GET['page'] == 'control_bd_message'){ $control_bd_message = ''; }
      else if($_GET['page'] == 'control_bd_recommended'){ $control_bd_recommended = ''; }
      else if($_GET['page'] == 'control_bd_checkBin'){ $control_bd_checkBin = ''; }
    ?>
    <aside class="main-sidebar">
      ...
      <div class="content-wrapper">
          <?php 
            switch ($_GET["page"]) {
            case "control_bd_video":
              include("hardware_control/control_sc_video.php");
              break;
            case "control_bd_message":
              include("hardware_control/control_bd_message.php");
              break;
            case "control_bd_recommended":
              include("hardware_control/control_sc_recommended.php");
              break;
            case "control_bd_checkBin":
              include("hardware_control/control_bd_checkBin.php");
              break;
            }
          ?>
      </div>
...
<footer class="main-footer" style="position: fixed;bottom: 0;height:80px;width: 100%;margin-left: 0px;">
        <div class="row">
          <div class="col-xs-2 col-sm-1">
            <a href="?page=control_bd_checkBin" data-toggle="tooltip" data-placement="top" title="เช็คสถานะ"><img src="img/menu/checkBin.png" style="width:50px;" <?php echo $control_bd_checkBin; ?>></a>
          </div>
          <div class="col-xs-2 col-sm-1">
            <a href="?page=control_bd_video" data-toggle="tooltip" data-placement="top" title="ควบคุมวีดีโอ"><img src="img/menu/video.png" style="width:50px;" <?php echo $control_bd_video; ?>></a>
          </div>
          <div class="col-xs-2 col-sm-1">
            <a href="?page=control_bd_message" data-toggle="tooltip" data-placement="top" title="การแสดงข้อความ"><img src="img/menu/message.png" style="width:50px;" <?php echo $control_bd_message; ?>></a>
          </div>
          <div class="col-xs-2 col-sm-1">
            <a href="?page=control_bd_recommended" data-toggle="tooltip" data-placement="top" title="กำหนดหนังสือแนะนำ"><img src="img/menu/add_book.png" style="width:50px;" <?php echo $control_bd_recommended; ?>></a>
          </div>
...
<script type="text/javascript">
  ...
  function preview(){
    document.getElementById('ifr_video_preview').src = 'control_sc_video_preview.php?arr='+ifr_select_array;
  }
